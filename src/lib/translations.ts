export const translations = {
    vi: {
        ...
        video: {
            ...
            subtitle: "Xem cách CIRA biến những bức ảnh thành câu chuyện đầy cảm xúc",
            placeholder: "Nhúng video của bạn vào đây (YouTube, Vimeo, hoặc file video)"
        },
        features: {
            title: "Tại Sao Chọn CIRA?",
            subtitle: "Giải pháp hoàn hảo cho gia đình hiện đại muốn kết nối qua các thế hệ",
            items: [
                {
                    icon: "🎙️",
                    title: "AI Kể Chuyện Ấm Áp",
                    description: "Biến mỗi bức ảnh thành câu chuyện sống động với giọng AI tự nhiên."
                },
                {
                    icon: "📸",
                ...
                },
                {
                    ...
                    description: "Mọi người cùng chia sẻ và gắn kết qua từng khoảnh khắc."
                },
                {
                    icon: "🔔",
        ...
        pricing: {
            ...
            plans: [
                ...
                },
                {
                    ...
                    features: [
                        "Không giới hạn ảnh",
                        "Album mở rộng (5+ người)",
                        "Tùy chỉnh giọng đọc",
                        "Video recap hàng tháng",
                        "Hỗ trợ ưu tiên"
                    ]
                }
            ]
    ...
    en: {
        ...
        video: {
            ...
            subtitle: "See how CIRA transforms photos into emotional stories",
            placeholder: "Embed your video here (YouTube, Vimeo, or video file)"
        },
        features: {
            title: "Why Choose CIRA?",
            subtitle: "The perfect solution for modern families wanting to connect across generations",
            items: [
                {
                    icon: "🎙️",
